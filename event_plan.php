...
<html lang="en">
    ...
    <body>
        ...
        <section class="research js--studies">
        ...
        <section class="research" >
            <div class="research-text">
                <a class="btn btn-full" href="#" onclick="printDiv('printableArea')" value="print a div!" />Print</a>
                <a class="btn btn-full" href="eventslist.php">Cancel</a>
                <br/><br/><br/><br/>
            </div>
